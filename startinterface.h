#ifndef SNAKEENV__STARTINTERFACE_H_
#define SNAKEENV__STARTINTERFACE_H_

#include <deque>
#include <vector>
#include "point.h"

class StartInterface {  // 开始画面，跟游戏内容没关系
 public:
  StartInterface() : speed(10) {
	...
	startsnake.emplace_back(Point(9, 14));  // 由point对象组成snake图案

	textsnake.emplace_back(Point(-26, 14));  //  描绘S
    ...
    textsnake.emplace_back(Point(0, 18));  // 由point组成snake字符
  }
  void PrintFirst();
  void PrintSecond();
  void PrintThird();
...
#endif //SNAKEENV__STARTINTERFACE_H_
